...
document.writeln('<script>let a = "%c  ' + copyright + '  %c 本项目基于Yuxuan Basic Admin构建 ";let b = "color: #fadfa3; background: #030307; padding:8px 0;";let c = "background: #fadfa3; padding:8px 0;";console.log(a, b, c)</script>');
